...
<div id="wrapper">
    ...
    <!--<section class="content" style="height: 300px; margin-top: 30px  ; background-image: url({{\Session::get('img_noticias')}});" data-stellar-background-ratio="0.6" data-stellar-vertical-offset="20"></section>-->
    ...
    <div class="white-wrapper">
        <div id="Practice_Area {{$fundo_branco_m3}}" style="margin-top: 10px; background: url({{\Session::get('bannermarcadagua')}}) no-repeat left;">
            <div id="team">
                <div class="container">
                    <div class="">
                        <div class="">
                            <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                                @if (!empty($noticias[0]->nomeImagem))
                                <br>
                                <img src="http://fatogerador.net/painelUnico/public/{{{ $noticias[0]->nomeImagem }}}" class="img-responsive" alt="Foto da Notícia">
                                @endif
                                <br>
                                <hr class="topoTitulo">
                                ...
                                <div class="info-post">
                                    <h5 style="line-height: 20px">
                                        Fonte: <b>{{{ $noticias[0]->fonte }}}</b>
                                        <br>
                                        <i class="fa fa-calendar cordata"></i><small class="cordata"> {{{ date('d/m/Y',strtotime($noticias[0]->data)) }}}</small>
                                        <br>
                                        <i class="fa fa-tag"></i> <?= $noticias[0]->categoria ?>
                                    </h5>
                                </div>
                                <br>
                                <p class="Cinza">
                                    <?php echo $noticias[0]->noticia ?>
                                </p>
                            </div><!-- end col-lg-3 -->
